                ...
                <div class="card tabsBox" id="tabs_id">
                    ...
                    <ul class="nav nested nav-pills mb-3" id="pills-tab" role="tablist">
                        ...
                        <?php if(session()->has('var_product_id')): ?>
                            <a
                                href="<?php echo e(route('edit.product_attributes', ['id' => session()->get('var_product_id') ?? $id])); ?>">
                        ...
                        <form action="<?php echo e(route('add.product_variation')); ?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                            ...
                                            <?php if(!empty($product->product_variants)): ?>
                                                <?php $__currentLoopData = $product->product_variants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_attribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="select-dropdown selectDropdown">
                                                        <select
                                                            class="form-control edit_attribute_e_<?php echo e($key); ?> detect_attribute_similarties"
                                                            name="attributes[]"
                                            ...
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                data-bs-target="#panelsStayOpen-e-<?php echo e($key); ?>" aria-expanded="true"
                                                aria-controls="panelsStayOpen-e-<?php echo e($key); ?>">
                                        ...
                                        <div id="panelsStayOpen-e-<?php echo e($key); ?>" class="accordion-collapse collapse"
                                            aria-labelledby="panelsStayOpen-e-<?php echo e($key); ?>">
                                ...
                                <?php $__currentLoopData = $collections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                                    ...
                                                    <div class="select-dropdown selectDropdown">
                                                        <select
                                                            ...
                                                            <?php $__currentLoopData = $product_attribute->product_additional_attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($attr->attribute_id); ?>">
                                                                    <?php echo e($attr->attribute); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </div>
                                            ...
                                            <button type="button" class="removeBtn"><a
                                                    href="<?php echo e(route('remove-variation-session', ['id' => $key])); ?>"
                                                    onclick="return confirm('Are you sure, you want to delete it?')">Remove</a></button>
                                        </h2>
                                                ...
                                                <div class="variationsBox">
                                                    <div class="row  mt-4 mb-4">
                                                        <div class="col-lg-6">
                                                            <div class="imageWrapper">
                                                                <img class="image"
                                                                    src="<?php echo e(asset('images/No-Image-Placeholder.svg')); ?>"
                                                                    alt="no image">
                                                            </div>
                                                            <button class="file-upload" type="button">
                                                                <input type="file" class="file-input" name="image[]">
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    ...
                                    <?php if(count($collections) > 0 || count($product->product_variations) > 0): ?>
