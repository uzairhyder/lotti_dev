  <footer class="footer cstm-column-width noPrint">
          ...
          <div class="contactBox">
            ...
            <div class="followLinks">
              <div class="contactLink d-flex">
                ...
                <div class="locationText">
                  <a href="mailto:<?php echo e($config->email ?? ''); ?>">
                    <p><?php echo e($config->email ?? ''); ?></p>
                  </a>
                </div>
              </div>
            </div>
            <div class="followLinks">
              <div class="contactLink d-flex">
                ...
                <div class="locationText">
                  <a href="tel:<?php echo e($config->contact ?? ''); ?>">
                    <p><?php echo e($config->contact ?? ''); ?></p>
                  </a>
                </div>
              </div>
            </div>
            <div class="followLinks">
              <div class="contactLink">
                ...
                <div class="locationText">
                  <a href="<?php echo e($config->map_link ?? ''); ?>" target="_blank">
                    <p><?php echo e($config->address); ?></p>
                  </a>
                </div>
              </div>
            </div>
    ...
    <div class="copyRight">
      <p><?php echo e($config->copy_right ?? ''); ?><br>
...
<?php /**PATH D:\xampp2\htdocs\lotti\resources\views/frontend/common/footer.blade.php ENDPATH**/ ?>