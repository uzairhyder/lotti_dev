                ...
                <div class="card tabsBox">
                    <ul class="nav nested nav-pills mb-3" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation" id="variat_tab">
                            <?php if(empty($product->product_variants[0]->product_attributes)): ?>
                            ...
                            <?php if(session()->has('collections')): ?>
                                <a href="<?php echo e(route('add.product_variation')); ?>">
                                    <button class="nav-link cstm_buttons">Variations</button>
                                </a>
                            <?php else: ?>
                                
                                <?php if($product->product_variants[0]->product_attributes): ?>
                                <a href="<?php echo e(route('edit.product_variation',['id' => $product->id])); ?>">
                                    <button class="nav-link cstm_buttons">Variations</button>
                                </a>
                                <?php else: ?>
                    ...
                    <form id="product" action="<?php echo e(route('update-prevdata', $products->id)); ?>" enctype="multipart/form-data"
                        method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="container">
                            <div class="row mb-3">
                                    ...
                                    <div class="select-dropdown">
                                        <select class="form-control" id="product_type" name="product_type">
                                            <option value="1" class="simple"
                                                <?php echo e($products->product_type == 1 ? 'selected' : ''); ?>>Simple product</option>
                                            <option value="2" class="variant"
                                                <?php echo e($products->product_type == 2 ? 'selected' : ''); ?>>Variable product
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="product_name" type="text"
                                            ...
                                            name="product_name" value="<?php echo e($products->product_name ?? ''); ?>">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                    ...
                                    <img src="<?php echo e(url('public/products/' . $products->image)); ?>" alt=""
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="sku" type="text"
                                            ...
                                            name="sku" value="<?php echo e($products->sku ?? ''); ?>">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select id="parent_category_id" name="parent_category_id"
                                            ...
                                            <?php $__currentLoopData = $parent_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parents): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option id="parent_category_id" value="<?php echo e($parents->id); ?>"
                                                    <?php echo e($parents->id == $products->parent_category_id ? 'selected' : ''); ?>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select id="main-category_id" for="exampleFormControlInput10"
                                            ...
                                            <?php $__currentLoopData = $main_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $main): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option id="parent_category_id" value="<?php echo e($main->id); ?>"
                                                    <?php echo e($main->id == $products->main_category_id ? 'selected' : ''); ?>

                                                    class="form-control btn-square">
                                                    <?php echo e($main->main_category_name); ?>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select id="sub-category_id" for="exampleFormControlInput10"
                                            ...
                                            <?php $__currentLoopData = $sub_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option id="parent_category_id" value="<?php echo e($sub->id); ?>"
                                                    <?php echo e($sub->id == $products->sub_category_id ? 'selected' : ''); ?>
                                        ...
                                        <select id="brand_id" for="exampleFormControlInput10"
                                            ...
                                            <?php $__currentLoopData = $brand; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($value->id); ?>"
                                                    <?php echo e($value->id == $products->brand_id ? 'selected' : ''); ?>>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control regularPrice" placeholder="Regular price"
                                            ...
                                            value="<?php echo e($products->total_price ?? ''); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control salePrice" placeholder="Sale price"
                                            id="sale_price" name="sale_price" value="<?php echo e($products->sale_price ?? ''); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Quantity" id="quantity"
                                            name="quantity" value="<?php echo e($products->quantity ?? ''); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" placeholder="Sale start date"
                                            ...
                                            value="<?php echo e(!empty($products->sale_start) ? date_format(date_create($products->sale_start), 'Y-m-d') : null); ?>">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" placeholder="Sale end date"
                                            ...
                                            value="<?php echo e(!empty($products->sale_end) ? date_format(date_create($products->sale_end), 'Y-m-d') : null); ?>">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" name="stock" id="shipping">
                                            <option value="1" <?php echo e($products->stock == 1 ? 'selected' : ''); ?>>In Stock</option>
                                            <option value="2" <?php echo e($products->stock == 2 ? 'selected' : ''); ?>>Out of stock</option>
                                        </select>
                                    </div>
                                </div>
                                        ...
                                        <select class="form-control" name="shipping" id="shipping">
                                            <?php if(!empty($shipping_fees)): ?>
                                                <?php $__currentLoopData = $shipping_fees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shipping_fee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($shipping_fee->id); ?>" <?php echo e($products->shipping == $shipping_fee->id ? 'selected' : ''); ?>><?php echo e($shipping_fee->zone_name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endif; ?>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3" id="tags_name">
                                        ...
                                        <select class="form-control js-example-tokenizer" name="tags[]" id="tags_value"
                                            multiple="multiple">
                                            <?php if(!empty($products->tags)): ?>
                                                <?php $__currentLoopData = json_decode($products->tags); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option selected="selected"><?php echo e($val); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endif; ?>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control editor" name="description" id="description"><?php echo e($products->description); ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
...
<?php echo $__env->make('admin_dashboard.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp2\htdocs\lotti\resources\views/admin_dashboard/product/product-edit.blade.php ENDPATH**/ ?>