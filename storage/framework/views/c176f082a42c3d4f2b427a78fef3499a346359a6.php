                ...
                <div class="card tabsBox" id="tabs_id">
                    ...
                    <ul class="nav nested nav-pills mb-3" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a href="<?php echo e(route('edit.product', session()->get('var_product_id'))); ?>">
                                    ...
                                    <?php if(count($variants) > 0): ?>
                                        <?php $__currentLoopData = $variants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($variant->id); ?>"
                                                <?php if(!empty($product_attributes)): ?> <?php $__currentLoopData = $product_attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attr_variant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div id="variant_accordion_html">
                        <form id="saveAttributeFrom" method="POST" action="<?php echo e(route('add.define_product_variant')); ?>">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin_dashboard.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp2\htdocs\lotti\resources\views/admin_dashboard/product/attribute.blade.php ENDPATH**/ ?>