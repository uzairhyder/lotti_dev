                            ...
                            <form action="" id="email-verify">
                                ...
                                <div class="d-flex flex-column">
                                    <input type="email" class="mt2" id="email" name="email"
                                        value="<?php echo e($user_email->email); ?>" readonly>
...
<?php echo $__env->make('frontend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp2\htdocs\lotti\resources\views/user-dashboard/email-verification.blade.php ENDPATH**/ ?>