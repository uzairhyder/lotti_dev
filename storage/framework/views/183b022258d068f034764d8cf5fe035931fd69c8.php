                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class=""><a class="btn btn-gradient" data-bs-original-title="" title=""
                                         href="<?php echo e(route('coupon.create')); ?>">Add</a></div>
                                ...
                                <table data-order='[[ 0, "desc" ]]' class="display dataTable no-footer" id="basic-1" role="grid"
                                    ...
                                    <?php $__currentLoopData = $coupons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                <?php echo e($value->coupon_code ?? null); ?>

                                            </td>
                                            <td>
                                                $<?php echo e($value->coupon_amount ?? 0); ?>

                                            </td>
                                            <td>
                                                <?php echo e($value->percentage ?? 0); ?>%
                                            </td>
                                            <td>
                                                <?php if($value->discount_type == 1): ?>
                                                    Fixed Cart Discount
                                                <?php endif; ?>
                                                
                                                <?php if($value->discount_type == 2): ?>
                                                    Fixed Product Discount
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php echo e($value->expiry_date ?? null); ?>

                                            </td>
                                            <td>
                                                0/<?php echo e($value->usage_limit_per_coupon ?? null); ?>

                                            </td>
                                            <td>
                          <a href="<?php echo e(route('coupon-status', $value->id)); ?>">
...
<?php echo $__env->make('admin_dashboard.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp2\htdocs\lotti\resources\views/admin_dashboard/coupon/index.blade.php ENDPATH**/ ?>