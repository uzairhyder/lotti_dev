                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form theme-form">
                            <form id="" action="<?php echo e(route('coupon.store')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="number" id="amount_setup_value" placeholder="Enter Coupon Amount"
                                                   ...
                                                   value="<?php echo e(old('coupon_amount')); ?>">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3" id="minimum_spend_hide">
                                            ...
                                            <input class="form-control" type="number" placeholder="Enter Minimum Spende"
                                                   ...
                                                   id="minimum_spend" value="<?php echo e(old('minimum_spend')); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12" id="maximum_spend_hide">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="number" placeholder="Enter Maximum Spend"
                                                   ...
                                                   name="maximum_spend" value="<?php echo e(old('maximum_spend')); ?>">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <select id="sub_cat_id" name="sub_category_id[]"
                                                    ...
                                                    multiple="multiple">
                                                <?php $__currentLoopData = $sub_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    
                                                    <option value="<?php echo e($val->id); ?>" class="form-control btn-square">
                                                        <?php echo e($val->sub_category_name); ?></option>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="number" placeholder="Enter Maximum Spend"
                                                   ...
                                                   value="<?php echo e(old('maximum_spend')); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control allwoed-email-select" id="allowed"
                                                ...
                                                <?php $__currentLoopData = $emails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($user->email); ?>" class="form-control btn-square">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div>
                                            ...
                                            <a class="btn btn-danger" href="<?php echo e(route('coupon.index')); ?>"
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            $(document).ready(function() {
                $("#product_id").on('change', function() {
                    ...
                    $.ajax({
                        type: "GET",
                        url: '<?php echo e(route('get_attributes_all')); ?>',
                        data: {
                            'id': id
                        },
                        success: function(response) {
        ...
        <script>
            ...
            $('.livesearch').select2({
                ...
                ajax: {
                    url: '<?php echo e(route('search_products_attr')); ?>',
                    dataType: 'json',
                    delay: 250,
        ...
        <script>
            $('.livesearch_variation').select2({
                ...
                placeholder: 'Select Products',
                ajax: {
                    url: '<?php echo e(route('products_attr_variation')); ?>',
                    dataType: 'json',
                    delay: 250,
                    processResults: function(data) {
                        return {
...
<?php echo $__env->make('admin_dashboard.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp2\htdocs\lotti\resources\views/admin_dashboard/coupon/create.blade.php ENDPATH**/ ?>