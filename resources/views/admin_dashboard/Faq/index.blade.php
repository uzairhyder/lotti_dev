                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class=""><a class="btn btn-gradient" data-bs-original-title="" title=""
                                href="{{ route('faqs.create') }}">Add</a></div>
                                    ...
                                    <tbody>
                                        @foreach ($faqs as $value)
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    <a href="javascript:void(0);" class="deletefaqs"
                                                        data-id="{{ $value->id }}">
                                                        <button class="btn btn-danger btn-xs" type="submit"
                                                            data-original-title="btn btn-danger btn-xs">Delete</button></a>

                                                    <a href="{{ route('faqs.edit', $value->id) }}"> <button
                ...
                $(".deletefaqs").on("click", function() {
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            toastr.success('Your Faq Deleted Sucessfully');
                            setTimeout(() => {
                                location.reload();
                            }, 1000);
                        }
