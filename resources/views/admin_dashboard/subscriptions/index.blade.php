                                    ...
                                    <tbody>
                                        @foreach ($subscriptions as $value)
                                            <tr role="row" class="odd">
                                                ...
                                                <td class="editDelete">
                                                    <form action="{{ route("subscription-delete", $value->id) }}" method="post">
                                                        @csrf
                                                        <a href="#">
                                                        <button class="btn btn-danger btn-xs" type="submit"
                                                            data-original-title="btn btn-danger btn-xs" onclick="return confirm('Are you sure you want to delete subscription email ?');" >Delete</button></a>
                                                    </form>
                                                </td>
                                            </tr>
                                        @endforeach
