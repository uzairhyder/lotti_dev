            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="panelsStayOpen-heading{{ $product_attribute->id }}">
                    ...
                    <button class="removeBtn" type="button"
                        onclick="removeVariant('{{ $product_attribute->variant_id }}','{{ $product_attribute->id }}')">Remove</button>
                </h2>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="2" name="used_for_variation{{ $product_attribute->id }}" id="used_for_variation{{ $product_attribute->id }}">
                                            <label class="form-check-label" for="used_for_variation{{ $product_attribute->id }}">
                                                Used for variations
                                            </label>
                                        </div>
                            ...
                            <div class="col-md-8">
                                <div class="secondBox">
                                    <div class="mb-3">
                                        <label>Value(s)</label>
                                        <textarea  name="cstm_attribute_value{{ $product_attribute->id }}" class="textAreaValue" placeholder='Enter some text, or some attributes by "|" separating values.'></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
