                    ...
                    <div class="accordion-body">
                                    ...
                                    <ul>
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input input_type_checkbox" type="checkbox" value="1" name="visible_product{{ $product_attribute->id }}" id="visible_product{{ $product_attribute->id }}" 
                                        ...
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input input_type_checkbox" type="checkbox" value="2" name="used_for_variation{{ $product_attribute->id }}" id="used_for_variation{{ $product_attribute->id }}" {{ $product_attribute->used_for_variation == 2 ? 'checked' : '' }}>
                            ...
                            <div class="col-md-8">
                                <div class="secondBox">
                                    ...
                                    <div class="form-group">
                                        <label>Values</label>
                                        <select name="attribute{{ $product_attribute->id }}[]" class="select_2 selected_{{ $product_attribute->id }} customAttribute" multiple
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    <label>Name</label>
                                    <input class="form-control cstm_attribute_name cstm_attribute_name{{ $product_attribute->id }}" name="cstm_attribute_name{{ $product_attribute->id }}" type="text" placeholder="" 
                                ...
                                <ul>
                                    <li>
                                        <div class="form-check">
                                            <input class="form-check-input input_type_checkbox" type="checkbox" value="1" name="visible_product{{ $product_attribute->id }}" id="visible_product{{ $product_attribute->id }}" {{ $product_attribute->visible_product == 1 ? 'checked' : '' }}>
                                            <label class="form-check-label" for="visible_product{{ $product_attribute->id }}">
                            ...
                            <div class="col-md-8">
                                <div class="secondBox">
                                    <div class="mb-3">
                                        ...
                                        {{-- <textarea  name="cstm_attribute_value{{ $product_attribute->id }}" class="textAreaValue" placeholder='Enter some text, or some attributes by "|" separating values.'>@if (!empty($product_attribute->product_attributes))@foreach($product_attribute->product_attributes as $item){{ $item->attribute }}@endforeach @endif</textarea> --}}
                                        


                                            <input type="hidden" name="cstm_attribute_ids{{ $product_attribute->id }}" value="{{ json_encode($custom_attr_ids) }}">
                                        

                                        <textarea name="cstm_attribute_value{{ $product_attribute->id }}" class="textAreaValue cstm_attribute_textarea" data-attr-id="{{ $product_attribute->id }}" placeholder='Enter some text, or some attributes by "|" separating values.'>{{ implode("|",$custom_values); }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
