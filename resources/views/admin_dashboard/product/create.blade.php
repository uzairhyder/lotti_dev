                            ...
                            <div class="row mt-4 mb-4" id="discounted_id">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control regularPrice" placeholder="Regular price" id="regular_price" name="regular_price" value="{{old('regular_price')}}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Quantity" id="quantity" name="quantity" value="{{old('quantity')}}">
                                    </div>
                                </div>
                                        ...
                                        <select class="form-control" name="shipping" id="shipping">
                                            @if (!empty($shipping_fees))
                                                @foreach ($shipping_fees as $shipping_fee)
                                                    <option value="{{ $shipping_fee->id }}">{{ $shipping_fee->zone_name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
