            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Shipping Method List </h5>
                        <div class=""><a class="btn btn-gradient" data-bs-original-title="" title=""
                                href="{{ route('shipping-method.create') }}">Add</a></div>
                                    ...
                                    <thead>
                                        <tr role="row">
                                            <th class="sorting_asc" tabindex="0" aria-controls="basic-1" rowspan="1"
                                                ...
                                                aria-label="Details: activate to sort column ascending">Shipping Title</th>
                                                <th class="sorting" tabindex="0" aria-controls="basic-1"
                                    ...
                                    <tbody>
                                        @foreach ($ship_method as $value)
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    {{ $value->shipping_title ?? null }}
                                                </td>
                                                @if(empty($value->shipping_price))
                                                <td>Free</td>
                                                @else
                                                <td>
                                                    ${{ $value->shipping_price ?? null }}
                                                </td>
                                                @endif
                                                <td>
                                                    <a href="{{ route('shipping-method-status', $value->id) }}">
                                                        @if ($value->status == 1)
                                                ...
                                                <td class="editDelete">
                                                    <form action="{{ route("shipping-method.destroy", $value->id) }}" method="post">
                                                    ...
                                                    <a href="{{ route('shipping-method.edit', $value->id) }}"> <button
