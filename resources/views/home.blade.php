							...
							<div class="media align-items-center">
								...
								<div class="media-body">
									<div class="right-chart-content">
										<h4>{{$inquiry_count ?? ''}}</h4>
										<span><i class="fa fa-phone fa-lg" aria-hidden="true"></i>Inquiries </span>
									</div>
								</div>
							</div>
						</div>
						<div class="col-xl-3 col-md-6 col-sm-6 p-0 box-col-6">
							<div class="media align-items-center">
								...
								<div class="media-body">
									<div class="right-chart-content">
										<h4>{{$user_count ?? ''}}</h4>
										<span><i class="fa fa-users fa-lg" aria-hidden="false"></i>Users</span>
									</div>
								</div>
							</div>
						</div>
						<div class="col-xl-3 col-md-6 col-sm-6 p-0 box-col-6">
							<div class="media align-items-center">
								...
								<div class="media-body">
									<div class="right-chart-content">
										<h4>{{$product_count ?? ''}}</h4>
										<span><i class="fa fa-rss fa-lg" aria-hidden="true"></i>Products</span>
									</div>
								</div>
							</div>
						</div>
						<div class="col-xl-3 col-md-6 col-sm-6 p-0 box-col-6">
							<div class="media border-none align-items-center">
								...
								<div class="media-body">
									<div class="right-chart-content">
										<h4>{{$order_count ?? ''}}</h4>
										<span><i class="fa fa-rss fa-lg" aria-hidden="true"></i>Order(s)</span>
									</div>
								</div>
							</div>
						</div>
                  ...
                  <div class="bg-primary b-r-4 card-body">
                    <div class="media static-top-widget">
                      ...
                      <div class="media-body"><span class="m-0">Orders</span>
                        @if($order_count > 0)
                            <h4 class="mb-0 counter">{{$order_count ?? ''}}</h4><i class="icon-bg" data-feather="shopping-cart"></i>
                        @else
                  ...
                  <div class="bg-secondary b-r-4 card-body">
                    <div class="media static-top-widget">
                      ...
                      <div class="media-body"><span class="m-0">Products</span>
                        @if($product_count > 0)
                            <h4 class="mb-0 counter">{{$product_count ?? ''}}</h4><i class="icon-bg" data-feather="shopping-bag"></i>
                        @else
                    ...
                    <div class="col-sm-6 pe-0">
                      <div class="media border-after-xs">
                        ...
                        <div class="media-body ammountRight">
                          <h5 class="mb-0">$<span class="counter">{{round($today_sale,2) ?? '0'}}</span></h5>
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-6 ps-0">
                      <div class="media">
                        ...
                        <div class="media-body ammountRight ps-2">
                          <h5 class="mb-0">$<span class="counter">{{round($month_sale,2) ?? '0'}}</span></h5>
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-6 pe-0">
                      <div class="media border-after-xs">
                        ...
                        {{-- <div class="media-body ammountRight align-self-center"><i class="font-primary" data-feather="arrow-up"></i></div> --}}
                        <div class="media-body ammountRight">
                          <h5 class="mb-0">$<span class="counter">{{round($week_sale,2) ?? '0'}}</span></h5>
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-6 ps-0">
                      <div class="media">
                        ...
                        <div class="media-body ammountRight ps-2">
                          <h5 class="mb-0">$<span class="counter">{{round($year_sale,2) ?? '0'}}</span></h5>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="col-xl-6 xl-100 box-col-12">
                <div class="widget-joins card">
                  <div class="row">
                    <div class="col-sm-6 pe-0">
                      <div class="media border-after-xs">
                        <div class="align-self-center me-3">{{round($pending_percentage ?? 0,2) ?? '0'}}%</div>
                        <div class="media-body details ps-3"><a href="{{route('orderManagement.index')}}"><span class="mb-1">Pending</span></a>
                          <h5 class="mb-0 counter">{{ $pending ?? ''}}</h5>
                        </div>
                    ...
                    <div class="col-sm-6 pe-0">
                      <div class="media border-after-xs">
                        <div class="align-self-center me-3">{{round($delivered_percentage ?? 0,2) ?? '0'}}%</div>
                        <div class="media-body details ps-3 pt-0"><a href="{{route('orderManagement.index')}}"><span class="mb-1">Done</span></a>
                          <h5 class="mb-0 counter">{{$delivered ?? 0}}</h5>
                        </div>
                    ...
                    <div class="col-sm-6 pe-0">
                      <div class="media">
                        <div class="align-self-center me-3">{{round(@$cancel_percentage ?? 0,2) ?? '0'}}%</div>
                        <div class="media-body details ps-3 pt-0"><a href="{{route('orderManagement.index')}}"><span class="mb-1">Cancel</span></a>
                          <h5 class="mb-0 counter">{{$cancelled ?? 0}}</h5>
                        </div>
