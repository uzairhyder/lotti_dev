...
">
        ...
        <tr>
            <th style="padding-bottom: 0px;">
              ...
              justify-content: space-between;
              ">
                    <span for="" style="width: 34%;text-align: right;"> DOB : </span>
                    <span for="" style="width: 64%;font-weight: 300;"> {{$data['dob']}}</span>
                </p>
            </th>
        ...
        <tr>
            <th style="padding-bottom: 0px;">
              ...
              justify-content: space-between;
              ">
                    <span for="" style="width: 34%;text-align: right;"> Gender : </span>
                    <span for="" style="width: 64%;font-weight: 300;"> {{$data['gender']}}</span>
                </p>
            </th>
        ...
        <!-- <tr>
            <th style="padding-bottom: 60px;">
                <p style="    width: 50%; font-family: system-ui;font-size: 24px;color: #fff;
                margin: 10px auto;
                text-align: left;"> DOP :<label for="" style="margin-left: 2rem; font-weight: 300;">14/09/2001</label>
                </p>
            </th>
